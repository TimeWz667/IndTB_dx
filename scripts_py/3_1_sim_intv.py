...
if __name__ == '__main__':
    ...
    for i, state in tqdm(enumerate(y0s[:20])):
        ...
        intvs = {
            ...
            'Mass_Xray_10_HRZE': compose_intv(p, acf='0.11_0.96'),
            'Mass_NAAT_20_HRZE': compose_intv(p, acf='0.22_0.86'),
            'Mass_Xray_10_PAN': compose_intv(p, acf='0.11_0.96'),
            'Mass_NAAT_20_PAN': compose_intv(p, acf='0.22_0.86'),
