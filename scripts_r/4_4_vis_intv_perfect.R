...
scs <- c(
  Baseline = "Baseline",
  PerfectDx = "No missed diagnosis",
  PerfectTxi = "No ILTFU",
  NoRelapse = "No post-treatment relapse"
)



sim <- read_csv(here::here("out", "dyage", "Sim_IntvIdeal.csv"))
...
g_avt
ggsave(g_avt, filename = here::here("docs", "figs", "g_intv_ideal_avt.png"), width = 12, height = 5)
