...
sim <- read_csv(here::here("out", "post_dy", "Sim_IntvTx.csv"))
...
ggsave(g_epi, filename = here::here("docs", "figs", "g_tx_epi.png"), width = 10, height = 5)
ggsave(g_avt, filename = here::here("docs", "figs", "g_tx_avt.png"), width = 10, height = 5)
