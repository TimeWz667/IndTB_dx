...
scs <- c(
  Baseline = "Baseline",
  "BCG" = "BCG revaccination",
  "M72" = "M72",
  "BCG-M72" = "Both",
  "Recurrence" = "Prevent recurrence"
)
...
ggsave(g_epi, filename = here::here("docs", "figs", "g_vac_epi.png"), width = 10, height = 5)
ggsave(g_avt, filename = here::here("docs", "figs", "g_vac_avt.png"), width = 10, height = 5)
